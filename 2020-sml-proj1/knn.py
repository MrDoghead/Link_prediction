...
save_as_pkl(best_parameters,'./knn_best_parameters.pkl')
...
test_pred = grid_search.predict_proba(test_x_std)
results = []
cnt = 1
for y in test_pred:
...
# save results
save_as_csv(results,'./results/knn_19_features_prediction_std.csv')
